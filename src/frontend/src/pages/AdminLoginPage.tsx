  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if ("ok" in result) {
        ...
        if (role !== "admin") {
          setError("Yeh account admin nahi hai.");
          toast.error("Admin access nahi mila.");
          return;
        }
        sessionStorage.setItem("mes_admin_email", email.trim());
        sessionStorage.setItem("mes_admin_password", hash);
